...
public class SimpleSequence2VecModel {
    ...
    public void rawPredictData () {
        net.rnnClearPreviousState();
        int[] idArray = new int [] {17,7,15,30,31,4};
        INDArray[] o = net.output(Nd4j.create(new double [][][] {{{17,7,15,30,31,4}}}));
        System.out.println(o[0]);
        System.out.println(o[0].getRow(0).tensorAlongDimension(idArray.length - 1,0));
        System.out.println(
                (int) Nd4j.getExecutioner().exec(
                        new IMax(o[0].getRow(0).tensorAlongDimension(idArray.length - 1,0)),
                        1).getDouble(0));
        return;
    }
